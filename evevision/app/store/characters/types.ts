...
export const UPDATE_CHARACTER_PUBLIC_INFO_PENDING = UPDATE_CHARACTER_PUBLIC_INFO + "_" + ActionType.Pending
export const UPDATE_CHARACTER_PUBLIC_INFO_FULFILLED = UPDATE_CHARACTER_PUBLIC_INFO + "_" + ActionType.Fulfilled
export const UPDATE_CHARACTER_PUBLIC_INFO_REJECTED = UPDATE_CHARACTER_PUBLIC_INFO + "_" + ActionType.Rejected

interface UpdateCharacterPublicInfoAction {
    type: typeof UPDATE_CHARACTER_PUBLIC_INFO | typeof UPDATE_CHARACTER_PUBLIC_INFO_PENDING | typeof UPDATE_CHARACTER_PUBLIC_INFO_FULFILLED | typeof UPDATE_CHARACTER_PUBLIC_INFO_REJECTED;
...
export type CharacterActionTypes = UpdateCharacterPublicInfoAction | UpdateCharacterAuthAction | DeleteCharacterAuthAction | UpdateApiStateAction;