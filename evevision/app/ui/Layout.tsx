...
export interface PanelProps extends LayoutProps {focused: boolean}
export const Panel: React.FC<PanelProps> = (props: PanelProps) => <div className={"eve-panel" + (props.focused ? ' focused' : '')}>{props.children}</div>