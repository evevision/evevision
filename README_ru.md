...
**Убедитесь, что у вас отключен DirectX 9 в настройках лаунчера**. Войдите в игру и играйте как ни в чем не бывало - остальное приложится. Если выйдет новая версия, приложение вас предупредит. Обратите внимание, что фоновое изображение показывается только членам Pandemic Horde, и скоро будет настраиваемым!
...
# Легальность.
Ядро EveVision полностью в рамках EULA, как ваш оверлей из дискорда или тимспика. CCP комментировали подобные виды приложений несколько лет назад: https://www.eveonline.com/article/overlays-isk-buyer-amnesty-and-account-security
...
##### Если вы планируете сделать приватный альянсовый/корпоративный инструмент, обратите внимание, что ядро этого приложения не предполагает изменений для отдельного распространения, и условия лицензии не позволяют вам делать этого без публикации полностью исходного кода. В ближайшем будущем будет система плагинов, которая будет позволять вам безопасно распространять инструменты.
