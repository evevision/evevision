...
class SoundCloudPlayer extends React.Component<SoundCloudPlayerProps> {
  ...
  componentDidUpdate(_prevProps: SoundCloudPlayerProps) {
    this.propsQueue.push({ ...this.props });
  }
  ...
  initSoundCloudWidget() {
    ...
    this.soundCloudWidget.bind(
      SoundCloudWidget.Events.PLAY_PROGRESS,
      (event: { currentPosition: number }) => {
  ...
  render() {
    ...
    return (
      <iframe
        ...
        allow="autoplay"
        src={src}
        onLoad={this.initSoundCloudWidget}
      ></iframe>
    );
  }
}
