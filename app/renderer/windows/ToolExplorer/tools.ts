...
const tools: ToolDescription[] = [
    ...
    },
    {
        name: "EVEWho",
        author: "Squizz Caphinator",
        description: "Find info on any character, corporation, or alliance in New Eden.",
        tags: ["info"],
        external: {
    ...
    },
    {
        ...
        author: "DeepL",
        description: "An alternative translator some say works better for certain languages",
        tags: ["communication"],
        external: {
