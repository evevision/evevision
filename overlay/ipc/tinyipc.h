...
struct IIpcClient
{
    ...
    virtual void onMessage(IIpcLink *, const EveVision::IPC::ClientMessageContainer* container) = 0;
...
struct IIpcCenter
{
    ...
    virtual bool sendMessage(IIpcLink* l, flatbuffers::FlatBufferBuilder* message) = 0;
...
struct IIpcHost
{
    ...
    virtual void onMessage(IIpcLink *link, EveVision::IPC::ClientMessageContainer* container) = 0;
};
